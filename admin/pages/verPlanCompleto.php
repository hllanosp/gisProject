...
<div id="preloader">
    <div id="status"><i class="fa fa-spinner fa-spin"></i></div>
                            ...
                            <div id="subPerfilProyecto" class="panel panel-default">
                                <div class="panel-body editable-list-group">
                                    ...
                                    <div id="contenidoPerfilProyecto" class="row col-md-12">
                                        <br>
                                        <div id="contenidoPlanOperativo" class="col-md-12">
                                            <table style="background-color:#EBEBEB;"  align="center" class="table table-bordered mb30" width="600px">
                                                <thead style="position: relative">
                                                    <tr>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);" width="10%">Componente</th>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);" width="10%">Producto</th>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);" width="10%">Actividad</th>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);" width="10%">Presupuesto</th>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);" width="15%">Fases</th>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);" width="15%">Inicio</th>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);" width="15%">Finalización</th>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);" width="15%">Responsable</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="planOperativo">
        ...
        <script src="../js/verPlanCompleto.js"></script>
    </body>
</html>
