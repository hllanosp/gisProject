...
<div id="preloader">
    <div id="status"><i class="fa fa-spinner fa-spin"></i></div>
        ...
        <section>
          ...
          <!-- Modal para agregar componentes  -->
                <div  class="modal fade" id="modalAgregarComponentes" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                 ...
                 <!-- Modal para editar componentes  -->
                <div  class="modal fade" id="modalEditarComponentes" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form role="form" id="formComponentesEditar" name="form_insertar" action="#">
                                <div class="modal-header" >
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                ...
                                <div class = "modal-body">                                   
                                    <div class="row">
                                        <div class="col-md-1"></div>
                                        <div class="col-md-10">
                                            <textarea type="text" name="componenteDescripcion2" placeholder="descripción del componente" id="componenteDescripcion2" class="form-control" required></textarea>
                                        </div>
                                        <div class="col-md-1"></div>
                                    </div>                                 
                                </div>
        ...
        <script src="../js/verComponentesProyecto.js"></script>
    </body>
</html>
