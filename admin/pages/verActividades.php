...
<div id="preloader">
    <div id="status"><i class="fa fa-spinner fa-spin"></i></div>
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <table align="center" class="table table-bordered mb30" width="600px">
                                                    <thead >
                                                        <tr >
                                                            <th style="text-align:center;background-color: rgb(186, 200, 226);" width="17%">Codigo del sistema</th>
                                                            <th style="text-align:center;background-color: rgb(186, 200, 226);" width="40%">Descripción</th>
                                                            <th style="text-align:center;background-color: rgb(186, 200, 226);" width="34%">Producto</th>
        ...
        <script src="../js/verActividades.js"></script>
    </body>
</html>
