...
<div id="preloader">
    <div id="status"><i class="fa fa-spinner fa-spin"></i></div>
        ...
        <section>
            ...
            <div class="mainpanel">
                ...
                <div class="pageheader">
                    <h2><i class="fa fa-bar-chart-o"></i>Seguimiento <span>Dar seguimiento</span></h2>
                    <!-- Migas de pan -->
                            ...
                            <div id="subPerfilProyecto" class="panel panel-default">
                                <div class="panel-body editable-list-group">
                                    ...
                                    <div id="contenidoPerfilProyecto" class="row col-md-12">
                                        <div id ="contenidoDarSeguimiento" class="col-md-12">
                                        </div>
        ...
        <script src="../js/darSeguimiento.js"></script>
    </body>
</html>
