    ...
    <div id="status"><i class="fa fa-spinner fa-spin"></i></div>
        ...
        <section>
                                            ...
                                            <table align="center" class="table table-bordered mb30" width="600px">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);">Estado</th>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);">Indicadores</th>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);">Informe</th>
                                                        <th style="text-align:center; background-color: rgb(186, 200, 226);">Acción</th>
                                                    </tr>
                                                </thead>
            ...
            <!-- Modal para editar Productos  -->
                    <div  class="modal fade" id="modalIndicadores" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            ...
                                            <div class="col-md-10">
                                                <div style="margin-bottom: 1%;" class="col-md-12">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <div  class="progress">
                                                            <div id="divTiempo" class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1"><label id="indicadorTiempo">20%</label></div>
                                                </div>
                                                ...
                                                <div style="margin-bottom: 1%;" class="col-md-12">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <div  class="progress">
                                                            <div id="divAlcance" class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1"><label id="indicadorAlcance" >40%</label></div>
                                                </div>
                                                ...
                                                <div style="margin-bottom: 1%;" class="col-md-12">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <div  class="progress">
                                                            <div id="divPresupuesto" class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 25%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1"><label id="indicadorPresupuesto">25%</label></div>
                                                </div>
                                            </div>
                                            <div class="col-md-1"></div>
                                        </div>
        ...
        <script src="../js/verSeguimiento.js"></script>
    </body>
</html>
