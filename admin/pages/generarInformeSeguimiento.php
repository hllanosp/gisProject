...
<div id="preloader">
    <div id="status"><i class="fa fa-spinner fa-spin"></i></div>
        ...
        <section>
            ...
            <div class="mainpanel">
                ...
                <div class="pageheader">
                    <h2><i class="fa fa-bar-chart-o"></i>Seguimiento <span>Generar informe</span></h2>
                    <!-- Migas de pan -->
                            ...
                            <form id ="formInforme">
                                        ...
                                        <div id="contenidoPerfilProyecto" class="row col-md-12">
                                            ...
                                            <div class="col-md-10">
                                                <table align="center" class="table table-bordered mb30" width="600px">
                                                    <thead>
                                                        <tr>
                                                            <th style="text-align:center; background-color: rgb(186, 200, 226);"width="10%">Actividad</th>
                                                            <th style="text-align:center; background-color: rgb(186, 200, 226);"width="30%">Fases</th>
                                                            <th style="text-align:center; background-color: rgb(186, 200, 226);"width="30%">Fecha Programacion Inical</th>
                                                            <th style="text-align:center; background-color: rgb(186, 200, 226);"width="30%">Fecha que se realizo</th>
                                                        </tr>
                                                    </thead>
                                ...
                                <div id="subPerfilProyecto" class="panel panel-default">
                                    <div class="panel-body editable-list-group">
                                        ...
                                        <div class="col-md-10">
                                                ...
                                                <label class="col-md-12" > Principales Resultados</label>
                                                <textarea  id ="resultadosText"class="form-control" class="col-md-12" style=" margin-bottom: 3%; height: 100px; background-color: #D0D9E7" required></textarea>
                                                <div style="margin-bottom: 2%;" class="col-md-12">
                                                    <label style="color: rgb(66, 139, 202);">Escala de medición según cumplimiento</label>
                                                </div>
                                                <div style="margin-bottom: 1%;" class="col-md-12">
                                                    ...
                                                    <div class="col-md-1"><label>20%</label></div>
                                                </div>
                                                ...
                                                <div style="margin-bottom: 1%;" class="col-md-12">
                                                    ...
                                                    <div class="col-md-1"><label>40%</label></div>
                                                </div>
                                                ...
                                                <div style="margin-bottom: 1%;" class="col-md-12">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div  class="progress">
                                                            <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 25%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1"><label>25%</label></div>
                                                </div>
                                        </div>
                                        <div class="col-md-1"></div> 
                                    </div>
                                ...
                                <div id="subPerfilProyecto" class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="col-md-1"></div> 
                                        <div class="col-md-10">
                                            <label class="col-md-12" >Introducción</label>
                                            <textarea  class="form-control" id="introduccion" class="col-md-12" style=" margin-bottom: 3%; height: 100px; background-color: #D0D9E7" required></textarea>
                                            <label class="col-md-12" >Objetivos de la Fase</label>
                                            <textarea  class="form-control" id="objetivos" class="col-md-12" style=" margin-bottom: 3%; height: 100px; background-color: #D0D9E7" required></textarea>
                                            <label class="col-md-12" >Conclusiones</label>
                                            <textarea class="form-control" id="concluciones" class="col-md-12" style=" margin-bottom: 3%; height: 100px; background-color: #D0D9E7"required ></textarea>
                                        ...
                                        <button class = "btn btn-primary" style="float:right; margin-top:1%" type="submit">Generar Informe</button>
        ...
        <script src="../js/generarInformeSeguimiento.js"></script>
    </body>
</html>
