            ...
            <div  class="modal fade" id="modalEditarEquipo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form role="form" id="formEditarEquipoModal" name="formEquipoModal" action="#">
                            ...
                            <div class = "modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <select class="form-control" id ="cargosEditarCombo" class="select2" data-placeholder="Seleccione un cargo...">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <select class="form-control" id="empleadosEditarEquipoCombo" class="select2" data-placeholder="Seleccione un Empleado..." required>
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type ="submit"  id="guardarEmpleado" class="btn btn-primary" >Editar</button>
                            </div>
                        </form>
                    </div>
                </div>
